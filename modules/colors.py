...
def pr_l_purple(skk): print("\033[94m {}\033[00m" .format(skk))


def pr_d_purple(skk): print("\033[95m {}\033[00m" .format(skk))


def pr_cyan(skk): print("\033[96m {}\033[00m" .format(skk))


def pr_l_gray(skk): print("\033[97m {}\033[00m" .format(skk))
